...
import { UserCheck, Search, Phone, MapPin, Stethoscope, Loader2 } from "lucide-react"
    ...
    return (
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h2 className="text-3xl font-bold tracking-tight">Doctores</h2>
            <p className="text-muted-foreground">Encuentra y conecta con profesionales de la salud.</p>
          </div>
        </div>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Encuentra y conecta con profesionales de la salud. ({doctors.length} doctores disponibles)
          </p>
        </div>
        ...
        <Card>
          <CardContent className="text-center py-12">
            ...
            <p className="text-gray-500">
              {searchTerm ? "No se encontraron doctores con ese criterio" : "No hay doctores disponibles"}
            </p>
            {searchTerm && (
